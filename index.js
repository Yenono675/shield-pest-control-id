...
var appRouter = router({
  ...
  chatbot: router({
    ask: publicProcedure.input(
      z2.object({
        question: z2.string().min(1, "Pertanyaan tidak boleh kosong")
      })
    ).mutation(async ({ input }) => {
      try {
...
Selalu berikan nomor WhatsApp 0811-3513-799 untuk konsultasi lebih lanjut.`;
        ...
        const answer = response.choices[0]?.message?.content || "Maaf, saya tidak dapat memproses pertanyaan Anda saat ini. Silakan hubungi kami melalui WhatsApp: 0811-3513-799";
        return {
          answer,
          success: true
        };
        ...
        return {
          answer: "Maaf, terjadi kesalahan. Silakan hubungi kami melalui WhatsApp: 0811-3513-799",
          success: false
        };
      }
    })
